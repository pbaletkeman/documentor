...
public final class ServiceMetricsUtils {
     ...
     */
    public static double calculateSuccessRate(final int successful,
            final int total) {
        if (total <= 0) {
            return 0.0;
        }
     ...
     */
    public static boolean meetsSuccessThreshold(final double successRate,
     ...
     */
    public static boolean isServiceHealthy(final double successRate,
            final double errorRate, final double minSuccess,
            final double maxError) {
        if (minSuccess < 0 || minSuccess > HUNDRED_PERCENT
                || maxError < 0 || maxError > HUNDRED_PERCENT) {
            return false;
        }
     ...
     */
    public static double calculateAvailability(final long uptimeMs,
     ...
     */
    public static String formatMetricsSummary(final double successRate,
            final double errorRate, final double availability) {
        return String.format(
                "Success: %.1f%%, Errors: %.1f%%, Availability: %.1f%%",
