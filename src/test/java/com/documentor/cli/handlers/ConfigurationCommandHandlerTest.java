...
class ConfigurationCommandHandlerTest {
    ...
    void handleValidateConfigFileNotFound() {
        ...
        ConfigurationCommandHandler handler =
    ...
    @Test
    void handleValidateConfigValidConfigProducesSummary(
        @TempDir final Path tmp) throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
    ...
    @Test
    void handleValidateConfigWithEmptyLlmModels(@TempDir final Path tmp)
        throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
    ...
    @Test
    void handleValidateConfigWithMissingApiKeys(@TempDir final Path tmp)
        throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
        ...
        LlmModelConfig modelWithNullKey = new LlmModelConfig("modelNull",
        "openai", "http://test", null, TEST_MAX_TOKENS, TEST_TIMEOUT_SECONDS);
        LlmModelConfig modelWithEmptyKey = new LlmModelConfig("modelEmpty",
        "openai", "http://test", "", TEST_MAX_TOKENS, TEST_TIMEOUT_SECONDS);
        LlmModelConfig modelWithWhitespaceKey =
            new LlmModelConfig("modelWhitespace",
        "openai", "http://test", "   ", TEST_MAX_TOKENS, TEST_TIMEOUT_SECONDS);
        LlmModelConfig modelWithValidKey = new LlmModelConfig("modelValid",
    ...
    @Test
    void handleValidateConfigWithInvalidJson(@TempDir final Path tmp)
        throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
    ...
    @Test
    void handleValidateConfigWithNullOutputSettings(@TempDir final Path tmp)
        throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
    ...
    @Test
    void handleValidateConfigWithNullAnalysisSettings(@TempDir final Path tmp)
        throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ConfigurationCommandHandler handler =
            new ConfigurationCommandHandler(mapper);
